...
<head>
     ...
     <title>HIT-Bus-Management-System-Home</title>
</head>
...
<body>
     ...
     <header>
          <nav>
               ...
               <div class="left-side-menu">
                    <div class="logo">
                         <h3>HIT Bus Management System</h3>
                    </div>
     ...
     <div class="main-highlight-display">
          <section class="main-body-panel">
               ...
               <div class="display">
                    <h1>Welcome to,</h1>
                    <h2>Hirasugar Institute of Technology</h2>
          ...
          <div class="bus-info-panel">
               <table>
                    ...
                    <tr>
                         ...
                         <td>Sankeshwar</td>
                         <td>Sankeshwar -> Kamatanur gate -> Kamatanur -> Nidasoshi  </td>
                    ...
                    <tr>
                         ...
                         <td>Arun Bamne</td>
                         <td>Hukkeri</td>
                         <td>Hukkeri -> Nerali -> Kamatanur gate -> Kamatanur -> Nidasoshi  </td>
                         <td>Morning: 8:45am<br>Evening: 5:10pm</td>
                         <td>50</td>
                         <?php
     ...
     <footer>
          <div id="copyright"> &copy;2024 All Right Reserved by<strong>&nbsp;HIT Bus Management System</strong>&nbsp;, HIT
          </div>
          <div id="design"><strong>designed by:</strong>&nbsp;Code Warriors</div>
     </footer>
